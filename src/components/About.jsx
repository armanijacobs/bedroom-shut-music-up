        ...
        <div className='bg-primary px-10 pt-8 text-center'>
            ...
            <div className='flex flex-col items-center'>
                <img
                    ...
                    src={about}
                    alt="" />
                <p className='text-white font-[montserrat] text-sm m-2 md:m-10 md:text-3xl'>This exhibition seeks to oﬀer an inter-generational reflection on the lived experiences of
